...
train_file_path = "/data/NNDL/data/train_test_split/part/train_part_2.txt"
test_file_path = "/data/NNDL/data/train_test_split/part/test_part_2.txt"
...
for epoch in range(num_epochs):
    ...
    if val_accuracy > best_val_accuracy:
        ...
        early_stopping_counter = 0
        torch.save(model.state_dict(), 'part_2_predictor_resnet50_model.pth')
    else:
...
with open('part_2_predictor_resnet50_training.json', 'w') as f:
